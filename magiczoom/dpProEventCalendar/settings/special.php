        ...
        <div id="dp_ui_content">
            ...
            <div id="leftSide">
                ...
                <ul id="menu" class="nav">
                    ...
                    <li><a href="javascript:void(0);" title="" class="active"><span><?php _e('Special Dates','dpProEventCalendar'); ?></span></a></li>
                </ul>
            ...
            <div id="rightSide">
                <div id="menu_general_settings">
                    <div class="titleArea">
                        <div class="wrapper">
                            <div class="pageTitle">
                                <h2><?php _e('Special Dates','dpProEventCalendar'); ?></h2>
                                <span><?php _e('Add special dates to use in the calendars. Such as holidays, company events, personal events, etc...','dpProEventCalendar'); ?></span>
                            </div>
                    ...
                    <div class="wrapper">
                    	<div id="dpProEventCalendar_SpecialDates" class="dpProEventCalendar_ModalManager" title="Add New Special Date">
                        ...
                        <input type="button" value="<?php echo __( 'Add new special date', 'dpProEventCalendar' )?>" class="btn_add_special_date" />
